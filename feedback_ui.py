...
QPushButton#clearButton, QPushButton#stopButton {
    background-color: #d32f2f;
}

QPushButton#clearButton:hover, QPushButton#stopButton:hover {
...
QTextEdit {
    ...
    color: #e0e0e0;
    font-size: 13px;
    selection-background-color: #3B99FC;
...
class FeedbackUI(QMainWindow):
    ...
    def _create_ui(self):
        ...
        contact_label = QLabel(
            'Need to improve? Contact Fábio Ferreira on <a href="https://x.com/fabiomlferreira" style="color: #3B99FC; text-decoration: none;">X.com</a> or visit <a href="https://dotcursorrules.com/" style="color: #3B99FC; text-decoration: none;">dotcursorrules.com</a>'
        )
        contact_label.setOpenExternalLinks(True)
        contact_label.setAlignment(Qt.AlignCenter)
        contact_label.setStyleSheet("color: #a0a0a0; font-size: 12px; padding: 8px 0;")
...
def feedback_ui(
    project_directory: str, prompt: str, output_file: Optional[str] = None
